...
<header><a class="brand" href="${base}world/"><strong>蝇境</strong><span>THE FLY OBSERVATORY</span></a><nav><a href="${base}">蝇弈</a><a href="https://github.com/tomzlabs/fly-xiangqi" target="_blank" rel="noreferrer">GitHub ↗</a></nav></header>
